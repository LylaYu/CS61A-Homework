...
import sys
sys.path.append('/Desktop/cs61a/hw/hog')
...
def free_bacon(score):
    ...
    # BEGIN PROBLEM 2
    if (score-score%10)//10*2-score%10>1:
        return (score-score%10)//10*2-score%10
    else:
        return 1
    # END PROBLEM 2
...
def is_swap(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 4
    if abs((player_score%100-player_score%10)//10-player_score%10) == abs((opponent_score%100-opponent_score%10)//10-opponent_score%10):
        return True
    else:
        return False
    # END PROBLEM 4
